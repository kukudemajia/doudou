/*
京东摇钱树 ：https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_moneyTree.js
更新时间：2020-11-16
...
[task_local]
#京东摇钱树
3 0-23/2 * * * https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_moneyTree.js, tag=京东摇钱树, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdyqs.png, enabled=true

==============Loon===========
[Script]
cron "3 0-23/2 * * *" script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_moneyTree.js,tag=京东摇钱树

===============Surge===========
京东摇钱树 = type=cron,cronexp="3 0-23/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_moneyTree.js

============小火箭=========
京东摇钱树 = type=cron,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_moneyTree.js, cronexpr="3 0-23/2 * * *", timeout=3600, enable=true
*/
  ...
  return new Promise((resolve, reject) => {
    $.post(taskurl('login', params), async (err, resp, data) => {
      try {
        ...
        $.msg("摇钱树-初始化个人信息" + eor.name + "!!", JSON.stringify(eor), eor.message)
      } finally {
        resolve(userInfo)
      }
    })
