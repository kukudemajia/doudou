...
京喜农场:脚本更新地址 https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_jxnc.js
...
==========================Quantumultx=========================
[task_local]
0 9,12,18 * * * https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_jxnc.js, tag=京喜农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxnc.png, enabled=true
[rewrite_local]
# 京喜农场APP种子Token
...
cron "0 9,12,18 * * *" script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_jxnc.js,tag=京喜农场

=========================Surge============================
京喜农场 = type=cron,cronexp="0 9,12,18 * * *",timeout=3600,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_jxnc.js
...
=========================小火箭===========================
京喜农场 = type=cron,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_jxnc.js, cronexpr="0 9,12,18 * * *", timeout=3600, enable=true
        ...
        for (let i = 0; i < jxncShareCodeArr.length; i++) {
            if (jxncShareCodeArr[i]) {
                ...
                if (!changeShareCodeJson(tmpjsonShareCodeArr[0])) {
                    ...
                    $.msg($.name, '互助码格式变更通知', '互助码格式变更，请重新填写 !!!!', option);
                    if ($.isNode()) {
                        await notify.sendNotify(`${$.name}`, `互助码格式变更，请重新填写 !!!!`);
                    }
                }
                break;
            }
