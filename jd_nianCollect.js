...
[task_local]
#京东炸年兽
50 * * * * https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_nianCollect.js, tag=京东收, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/main/Icon/lxk0301/jd_nianCollect.png, enabled=true

================Loon==============
[Script]
cron "50 * * * *" script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_nianCollect.js,tag=京东收

===============Surge=================
京东收 = type=cron,cronexp="50 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_nianCollect.js

============小火箭=========
京东收 = type=cron,script-path=https://raw.githubusercontent.com/kukudemajia/doudou/master/jd_nianCollect.js, cronexpr="50 * * * *", timeout=3600, enable=true
 */
        ...
        if (err) {
          ...
          if (data) {
            ...
            if (data && data.data.bizCode === 0) {
              ...
              console.log(`京东账号${$.index} ${$.nickName}成功收集爆竹失败:${data.data.bizMsg}`)
            }
          } else {
